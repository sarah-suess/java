...
public interface List<T> {
     ...
     * For example, if our List contains [“a”, “b”, “c”, “d”], then reverseLinkedList()
     * should return a new List containing [“d”, “c”, “b”, “a”]. Note that you are not
     * allowed to use any auxiliary data structures to solve this problem. In other words,
     * storing all the Nodes in an array or ArrayList and then iterating through it backwards
     * to build the new list is not a valid solution.
     * If the original List is empty,
     * throw an IllegalArgumentException with a message “List is empty”
     * @return a new List object containing the odd elements in the current list, as described above
     */
    List<T> reverseLinkedList();
}
